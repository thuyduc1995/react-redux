...
export class DatatableWidget extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            disableColumn: this.props.data.configs.dataSource === 'Contacts' ?
                difference(Object.keys(this.props.contact[0]), this.props.data.configs.activeColumn).map(item => item) :
